...
public class PacienteDAO extends BaseDAO{
    ...
    public static List<PacienteModel> selectPacienteNotPassword(){
                ...
                )
        {
            List<PacienteModel> pacientes = new ArrayList<>();
            while(rs.next()) {
                pacientes.add(resultsetToPacienteNotPassword(rs));
            }
            return pacientes;
        }catch(SQLException e){
            e.printStackTrace();
    ...
    public static PacienteModel selectForLogin(String email, String senha){
    ...
    private static PacienteModel resultsetToPacienteNotPassword(ResultSet rs) throws SQLException {
        PacienteModel paciente = new PacienteModel();
        paciente.setNome(rs.getString("nome"));
        paciente.setEmail(rs.getString("email"));
        paciente.setCpf(rs.getString("cpf"));
...
//        System.out.println(PacienteDAO.selectForLogin("santos@gmail.com", "345345"));
    }
}
